...
if __name__ == '__main__':
    ...
    parser.add_argument('--oppo', type=str, choices={'ac', 'mfac', 'mfq', 'il', 'rnnIL', 'rnnMFQ', 'pomfq'}, help='indicate the opponent model')
    ...
    with open('numberofwins_multibattle.csv', 'w+') as myfile:
        myfile.write('{0},{1},{2}\n'.format("Game", "nw1", "nw2"))
    ...
    for k in range(0, args.n_round):
        ...
        with open('numberofwins_multibattle.csv', 'a') as myfile:
