...
class EpisodesBufferEntry:
    ...
    def append(self, feature, feature2, action, reward, alive, probs0=None, probs1 = None):
...
class EpisodesBuffer(Buffer):
    ...
    def push(self, **kwargs):
        ...
        for i in range(len(ids)):
            ...
            if self.use_mean:
                entry.append(feature[i], feature2[i], acts[i], rewards[i], alives[i], probs0=probs0[i], probs1 = probs1[i])
            else:
...
class AgentMemory(object):
    ...
    def append(self, feat0, feat2, act, reward, alive, prob0=None, prob1=None):
