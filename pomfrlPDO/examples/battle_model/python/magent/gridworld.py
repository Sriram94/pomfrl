...
class GridWorld(Environment):
    ...
    def get_neighbors(self,j,pos_list,r=5):
        """
        ...
        for i,pos in enumerate(pos_list):
            ...
            if dist < r:
                s = math.exp(-dist)
                choice = np.random.choice(2,1,p=[1-s, s])
                if choice == 1:
    ...
    def new_gamma(self, a, b, theta, pos_j, pos_list): 
        """ 
        Given the Gaussian parameters and the position list, calculate the new set of parameters and return it back
        """ 
        new_a1 = a + 1
        new_a2 = a
        sum_dist = 0
        ...
        new_b1 = b + sum_dist - (sum_dist/theta)
        new_b2 = new_b1
        return new_a1, new_b1, new_a2, new_b2
